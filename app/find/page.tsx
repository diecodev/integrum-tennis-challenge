...
export default async function FindTournamentsPage() {
  ...
  if (!tournaments.length) {
    return (
      <main className="grid place-items-center min-h-[calc(100vh_-_6rem)]">
        <p className="text-sm flex gap-2 items-center justify-center text-slate-500 mt-2">
          ...
          Oh no! It seems all tournaments have concluded. Fret not, there&apos;s
          sure to be another one coming up soon. Stay tuned!
        </p>
      </main>
    );
  }
